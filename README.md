...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aiomcache-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6943&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aiomcache-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aiomcache` can be installed with:

```
conda install aiomcache
```

It is possible to list all of the versions of `aiomcache` available on your platform with:
